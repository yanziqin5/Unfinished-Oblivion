...
基于 PyQt5 开发，无边框磨砂 UI、纯画布模式、动态光影氛围，支持 AI 对话续写、归档收藏与导出。
...
- **AI 对话**：接入豆包大模型，获取AI批注
- **归档收藏**：重要页面归档保存，归档网格浏览
- **导出功能**：支持将笔记导出为文本或图片
- **字体管理**：内置文艺字体，支持自定义字体
- **快捷键**：丰富的键盘快捷键，高效操作
- **本地存储**：SQLite 数据库，所有数据仅存于本机
...
在软件中打开 AI 对话框，填入豆包 API Key 即可使用 AI 批注功能。
...
所有笔记数据存储在本地 `data/` 目录下的 SQLite 数据库中，不会上传到任何服务器。
